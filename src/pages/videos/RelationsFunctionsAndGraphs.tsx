...
const RelationsFunctionsAndGraphs: React.FC = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold border-b-2 border-gray-300 mb-4">Relations, Functions and Graphs</h2>

        {relationsFunctionsAndGraphsVideos.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {relationsFunctionsAndGraphsVideos.map(video => (
...
export default RelationsFunctionsAndGraphs;
